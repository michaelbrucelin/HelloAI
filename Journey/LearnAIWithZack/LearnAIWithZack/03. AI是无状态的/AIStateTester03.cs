...
namespace LearnAIWithZack._03._AI是无状态的
{
    public class AIStateTester03 : InterfaceAIStateTester
    {
        ...
        public async Task Test()
        {
            ...
            IMemoryService memoryService = serviceProvider.GetRequiredService<IMemoryService>();
            MemoryConfig memoryConfig = serviceProvider.GetRequiredService<IOptions<MemoryConfig>>().Value;
